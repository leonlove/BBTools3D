...
set log_file=%dir_log%\build_laslib.log
...
set package_name=LasLib.tar.gz
set package_dir=%dir_build%\laslib
...
:: 创建cmake源码编译路径
set package_dir_build=%package_dir%\laslib\build
